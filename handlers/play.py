...
async def play(_, message: Message):
    ...
    lel = await message.reply("**__🎵 ᴘʀᴏᴄᴇssɪɴɢ 🎵__**")
                      ...
                      if administrator == message.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  ...
                                  "\n\nOr manually add @Sparkyxmusic to your Group and try again</b>",
    ...
    await lel.edit("**__🎧 ᴘʀᴏᴄᴇssɪɴɢ sᴏɴɢ 🎧__**")
    ...
    keyboard = InlineKeyboardMarkup(
            ...
            [   
                ...
                [
                    ...
                    InlineKeyboardButton('ʏᴏᴜᴛᴜʙᴇ 📽️', url=f'{url}'),
                ...
                [
                    ...
                    InlineKeyboardButton(text="sᴘᴀʀᴋʏ ✨", url=f"https://t.me/Sparkypro_support")
